    ...
    <div className="font-serif px-10 py-8 max-w-4xl mx-auto bg-white text-black" style={{ width: '8.5in', minHeight: '11in' }}>
      <header className="text-center mb-3 border-b-[1.5px] border-black pb-2">
        ...
        <div className="text-xs flex flex-wrap justify-center items-center gap-2">
          ...
          {personal_info.linkedin && <a href={personal_info.linkedin.startsWith('http') ? personal_info.linkedin : `https://${personal_info.linkedin}`} target="_blank" rel="noreferrer" className="flex items-center gap-1 ml-2 hover:underline">
          ...
          {personal_info.github && <a href={personal_info.github.startsWith('http') ? personal_info.github : `https://${personal_info.github}`} target="_blank" rel="noreferrer" className="flex items-center gap-1 ml-2 hover:underline">

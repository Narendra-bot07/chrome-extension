    ...
    <div className="font-sans bg-white text-zinc-900 flex" style={{ width: '8.5in', minHeight: '11in' }}>
        ...
        <div className="w-[32%] bg-zinc-50/60 p-8 border-r border-zinc-200">
          ...
          <div className="flex flex-col space-y-3 mb-10 text-xs font-medium text-zinc-700">
            ...
            <a href={personal_info.linkedin.includes('linkedin.com') ? (personal_info.linkedin.startsWith('http') ? personal_info.linkedin : `https://${personal_info.linkedin}`) : `https://linkedin.com/in/${personal_info.linkedin}`} target="_blank" rel="noreferrer" className="flex items-center gap-3 hover:underline">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-600"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
              <span>{personal_info.linkedin.replace(/^(https?:\\/\\/)?(www\.)?/, '')}</span>
            </a>
          )}
          {personal_info.github && (
            <a href={personal_info.github.includes('github.com') ? (personal_info.github.startsWith('http') ? personal_info.github : `https://${personal_info.github}`) : `https://github.com/${personal_info.github}`} target="_blank" rel="noreferrer" className="flex items-center gap-3 hover:underline">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-600"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>

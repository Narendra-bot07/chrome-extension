...
export default function HowItWorksModal({ isOpen, onClose }) {
  ...
  return (
    <MotionModal open={isOpen} onClose={onClose} className={`relative max-w-4xl ${darkMode ? 'bg-zinc-900 text-white border-zinc-800' : 'bg-white text-zinc-900 border-zinc-200'}`}>
        {/* Header */}
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className={`p-5 rounded-xl border ${darkMode ? 'bg-zinc-800/50 border-zinc-700/50' : 'bg-zinc-50 border-zinc-200'}`}>
              ...
              <p className={`text-sm leading-relaxed ${darkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>
                tailr4u compares your base resume against the extracted job description, identifying critical keyword gaps and generating a baseline ATS match score before tailoring.
              </p>
            </div>
          ...
          <div className="mt-8 border-t border-inherit pt-8">
            ...
            <div className="space-y-4">
              ...
              <div className={`p-4 rounded-lg border ${darkMode ? 'border-zinc-800 bg-zinc-900/50' : 'border-zinc-200 bg-white'}`}>
                ...
                <p className={`text-sm ${darkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>
                  Yes. All templates generated by tailr4u use strict, parseable semantic structures designed explicitly to pass through Applicant Tracking Systems (Workday, Greenhouse, Lever) without formatting errors.
                </p>
              </div>

  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${getApiUrl()}/api/v1/auth/login`, {
        ...
        body: JSON.stringify({ email: loginEmail, password: loginPassword, installation_id: installationId })
      });
      ...
      <div className="hidden lg:flex flex-col justify-between w-[48%] p-12 bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 relative z-10">
        <div>
          ...
          <div className="mt-20 max-w-lg space-y-6">
            ...
            <h1 className="text-4xl font-black tracking-tight text-zinc-900 dark:text-white leading-tight">
              Sign in to your job applications workspace.
            </h1>

            <p className="text-xs font-bold text-zinc-500 dark:text-zinc-400 leading-relaxed uppercase tracking-wider">
              Manage tailored resumes, track application pipelines, and stay ahead of every recruiter interview.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4 pt-10 border-t border-zinc-100 dark:border-zinc-800">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-xs font-black uppercase tracking-wider text-zinc-900 dark:text-white">Smart Tailoring</h4>
              <p className="text-[11px] text-zinc-500 font-medium">Instant ATS resume optimization per job description</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-xs font-black uppercase tracking-wider text-zinc-900 dark:text-white">Full-Width Tracker</h4>
              <p className="text-[11px] text-zinc-500 font-medium">Organize applications, notes, contacts, and timeline events</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <form onSubmit={handleLogin} className="order-4 space-y-4">
            ...
            <div>
              <div className="mb-1 flex items-center justify-between">
                <label className="block text-[11px] font-bold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider">Password</label>
                <Link to="/forgot-password" state={{ email: loginEmail }} className="text-xs font-bold text-[#00bda5] hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">

  ...
  if (!activeResume) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-950 text-zinc-300 gap-4 p-6 text-center">
        <div className="text-base font-extrabold text-zinc-100">No Active Resume Found</div>
        <p className="text-xs text-zinc-400 max-w-sm">Please select or upload a resume to explore templates and compose PDFs.</p>
        <button

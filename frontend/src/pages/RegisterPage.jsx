      ...
      >
        ...
        <div className="space-y-8 my-auto relative z-10 max-w-md select-none">
          ...
          <div className="space-y-4 pt-5 border-t border-zinc-150">
            ...
            <div className="flex items-start gap-4">
              <div className="w-6 h-6 rounded-lg bg-zinc-100 text-zinc-850 flex items-center justify-center text-[11.5px] font-black shrink-0 border border-zinc-200">
                2
              </div>
              <div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-450 hover:text-zinc-655 transition-colors border-none bg-transparent cursor-pointer"
                      >

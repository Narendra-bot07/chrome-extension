...
TEMPLATES: Dict[str, Dict[str, Any]] = {
    ...
    "reminder.scheduled": {"category":"reminder","type":"REMINDER_SCHEDULED","priority":"normal","title":"Reminder scheduled","message":"{reminder_title} — {scheduled_label}. {note}","action_label":"View Reminder","action_url":"/job-tracker?application={application_id}&reminder={reminder_id}"},

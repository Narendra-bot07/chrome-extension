...
class TailoringRepository:
    ...
    def create_tailored(self, user_id: str, original_resume_id: str, job_description_id: str, tailored_content: Dict[str, Any], ats_score: float) -> Dict[str, Any]:
        ...
        with self.conn.cursor(cursor_factory=RealDictCursor) as cur:
            ...
            if record:
                ...
                self._create_version_internal(cur, tailored_resume_id, tailored_content, "Initial tailoring generation")
    ...
    def _create_version_internal(self, cur, tailored_resume_id: str, content: Dict[str, Any], changes_summary: str):
        query = """
